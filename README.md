...
* [2. Data Understanding Phase](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#data-understanding-phase)
	* [2.1 Collect Initial Data](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#21-collect-initial-data)
	* [2.2 Describe Data](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#22-describe-data)
	* [2.3 Explore Data](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#23-explore-data)
	* [2.4 Verify Data Quality](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#24-verify-data-quality)
...
* [4. Modeling Phase](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#modeling-phasesentiment-analysis)
	* [4.1 Selecting Modeling Techniquies](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#41-selecting-modeling-techniquies)
	* [4.2 Generate Test Design](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#42-generate-test-design)
	* [4.3 Build Model](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#43-build-model)
	* [4.4 Assess Model](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#44-assess-model)
* [5. Evaluation Phase](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#evaluation-phase)
	* [5.1 Evaluate Results](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#51-evaluate-results)
	* [5.2 Review Process](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#52-review-process)
	* [5.3 Determine Next Steps](https://github.com/LMU-MSBA/bsan-6080-playstation/blob/main/README.md#53-determine-next-steps)	
...
``````````````````````````````````````````````````````````````````````````````````````
data['tweet']
0        @Hammodyy100120 @adaVP @AishaHakami9 @Dark_Sid...
1        @PNDKetchup @ultradavid @PlayStation Will you ...
2        Sony is the best video game maker in the world...
3        @GermanStrands The next @PlayStation showcase ...
4                          @rcats99 @PlayStation CONGRATS!
                               ...                        
19413                                @PlayStation Purple 🔥
19414    Day 299 of asking @Sony @PlayStation and @herm...
19415    @Innthacut @kidsmoove @PlayStation Are you rea...
19416    @PlayStation To be honest once i can reach for...
19417    @TheViennri @lilley_ross @kidsmoove @PlayStati...
Name: tweet, Length: 19418, dtype: object
``````````````````````````````````````````````````````````````````````````````````````````
